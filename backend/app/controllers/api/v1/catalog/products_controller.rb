    ...
    module Catalog
      class ProductsController < ::Api::V1::BaseController
        ...
        def index
          ...
          # sub_category_counts = filterProducts
          res = filterProducts
          @products = @products.order(:id).limit(res[:per_page]).offset((res[:page] - 1) * res[:per_page])
        ...
        def metadata
          ...
          total_pages = [(total_count.to_f / res[:per_page]).ceil, 1].max
          ...
          render json: {
              meta: {
                ...
                sub_category_counts: res[:sub_category_counts]
            }
          }
